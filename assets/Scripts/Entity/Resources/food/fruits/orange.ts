...
@ccclass
export default class Orange extends FoodBase {
    itemName: string = "orange"; 
    onLoad() {
        super.onLoad();
        cc.log(`[orange] onLoad → ${this.foodName || this.itemName}, rottenTime=${this.rottenTime}`);
        const def = getItemDefinition("orange");
        if (def) {
